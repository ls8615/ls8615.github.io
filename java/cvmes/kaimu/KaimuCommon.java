...
public class KaimuCommon extends AbstractSubServiceThread {
    private String msg = "";

    @Override
    public void initServiceCode() {
        this.strServiceCode = "KaimuCommon";
    }
    ...
    public String runBll(Record rec_service) throws Exception {
        ...
        try {
            ...
            ActiveRecordPlugin arp = new ActiveRecordPlugin("kaimu", dp);
            // 设置数据库方言
            ...
            try {
                ...
                arp.stop();
                dp.stop();
                msg = String.format("创建kaimu连接池失败，原因【%s】", ex.getMessage());
