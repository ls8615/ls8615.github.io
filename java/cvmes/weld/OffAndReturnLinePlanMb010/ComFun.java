...
public class ComFun {
     ...
     * 获取MB010离线回线计划sql
     */
    public static String getOffAndReturnLinePlanMb010Plan() {
        ...
        sql.append("           AND (T.STATION_CODE = 'MB010' OR");
        sql.append("               T.RETURNLINE_STATION_CODE = 'MB010')");
    ...
    public static String getOffDealSql(){
        ...
        sql.append("   AND O.STATION_CODE = 'MB010'");
    ...
    public static String getRetrunDealSql(){
        ...
        sql.append("       O.RETURNLINE_STATION_CODE = 'MB010'");
        sql.append(" WHERE O.PRODUCTION_CODE =");
        sql.append("       (SELECT D.PRODUCTION_CODE");
        sql.append("          FROM T_PLAN_DEMAND_PRODUCT D");
        sql.append("         WHERE D.K_STAMP_ID = ?)");
