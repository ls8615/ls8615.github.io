...
public class ZzzkCommon extends AbstractSubServiceThread {
    private String msg;

    @Override
    public void initServiceCode() {
        this.strServiceCode = "ZzzkCommon";
    }
    ...
    public String runBll(Record rec_service) throws Exception {
        ...
        try {
            ...
            ActiveRecordPlugin arp = new ActiveRecordPlugin("zzzk", dp);
            // 设置数据库方言
            ...
            try {
                ...
                arp.stop();
                dp.stop();
                msg = String.format("创建zzzk连接池失败，原因【%s】", ex.getMessage());
